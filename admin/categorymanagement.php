<?php
  ...
  if(isset($_POST['insertdata'])) {
    ...
    $query = "INSERT INTO tbl_category(cate_name)
              VALUES('$cate_name')";
  ...
  if(isset($_POST['updatedata'])) {
    $cate_id = $_POST['update_cate_id'];
    $cate_name = $_POST['update_cate_name'];

    $connect = new mysqli("localhost", "root", "", "whalewatch");

    $query = "UPDATE tbl_category SET cate_name = '$cate_name' WHERE id = '$cate_id'";
    $query_run = mysqli_query($connect, $query);
        ...
        <div class="modal-content">
          ...
          <form action="" method="POST">
            <div class="modal-body">
              ...
              <div class="form-group">
                <label>Cate Name</label>
                <input type="text" name="update_cate_name" id="update_cate_name" class="form-control" placeholder="Fullname">
              </div>
            </div>
            ...
            <ul id="main-menu-navigation" data-menu="menu-navigation" data-scroll-to-active="true" class="navigation navigation-main">
              <li class="has-sub nav-item"><a href="#"><i class="ft-home"></i><span data-i18n="" class="menu-title">Dashboard</span><span class="tag badge badge-pill badge-danger float-right mr-1 mt-1">2</span></a>
                <ul class="menu-content">
                  ...
                  <li class="active"><a href="categorymanagement.php" class="menu-item">Category Management</a>
                  </li>
                </ul>
              </li>
                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="contact-card">
                      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#cateaddmodal">Add category
                      </button>
                    </div>
                  </div>
                      ...
                      <table class="table table-light">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><?php echo "<a href='productbycate.php?cateid=".$row['id']."'>".$row['cate_name']."</a>"; ?></td>
                            <td>
