          ...
          <form action="updateorder.php" method="POST">
            <div class="modal-body">
              <div class="form-group">
                ...
                <input type="text" name="order_id" readonly id='order_id' class="form-control">
              </div>
              <div class="form-group">
                <label>User ID</label>
              ...
              <div class="form-group">
                ...
                <input type="text" name="datep" readonly id="datep" class="form-control">
              </div>
              <div class="form-group">
                <label>Total</label>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form action="deleteorder.php" method="POST">
            <div class="modal-body">
              <input type="hidden" name="del_order_id" id='del_order_id'>
            ...
            <ul id="main-menu-navigation" data-menu="menu-navigation" data-scroll-to-active="true" class="navigation navigation-main">
              <li class="has-sub nav-item"><a href="#"><i class="ft-home"></i><span data-i18n="" class="menu-title">Dashboard</span><span class="tag badge badge-pill badge-danger float-right mr-1 mt-1">2</span></a>
                <ul class="menu-content">
                  ...
                  <li class="active"><a href="ordermanagement.php" class="menu-item">Order Management</a>
                  </li>
                ...
                <div class="card">
                  ...
                  <div class="card-content">
                    ...
                    <?php 
                        ...
                        $query = "SELECT tbl_orderdetail.id, tbl_product.product_name, tbl_orderdetail.quantity, tbl_product.image FROM `tbl_orderdetail` JOIN tbl_product ON tbl_product.id = tbl_orderdetail.product_id WHERE order_id = $orderid";
                  ...
                  <span><a href="ordermanagement.php">Return to order</a></span>
                </div>
              </div>
            </div>
<div class="row">
