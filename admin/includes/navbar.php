            ...
            <div id="navbarSupportedContent" class="collapse navbar-collapse">
              <ul class="navbar-nav">
                ...
                <li class="dropdown nav-item"><a id="dropdownBasic3" href="#" data-toggle="dropdown" class="nav-link position-relative dropdown-toggle"><i class="ft-user font-medium-3 blue-grey darken-4"></i>
                  ...
                  <div ngbdropdownmenu="" aria-labelledby="dropdownBasic3" class="dropdown-menu text-left dropdown-menu-right"><a href="./chat.html" class="dropdown-item py-1"><i class="ft-message-square mr-2"></i><span>Chat</span></a><a href="./user-profile-page.html" class="dropdown-item py-1"><i class="ft-edit mr-2"></i><span>Edit Profile</span></a><a href="./inbox.html" class="dropdown-item py-1"><i class="ft-mail mr-2"></i><span>My Inbox</span></a>
                    <?php 
                      if(isset($_SESSION['admin'])) {
                        echo "<div class='dropdown-divider'></div><a href='./logout.php' class='dropdown-item'><i class='ft-power mr-2'></i><span>Logout</span></a>";
                      } else {
                        echo "<div class='dropdown-divider text-center'></div><a href='./login.php' class='dropdown-item'><span>Login</span></a>";
                      }
                     ?>
                  </div>
                </li>
